        ...
        <section id="premium" className="py-24 bg-gradient-to-b from-black/50 to-primary/5">
          <div className="container mx-auto px-6 text-center">
            <div className="inline-flex items-center gap-2 px-4 py-1 rounded-full bg-yellow-500/10 border border-yellow-500/20 text-yellow-500 mb-6">
              ...
              <span className="text-sm font-bold uppercase tracking-widest">Премиум Доступ</span>
            </div>
            
            <h2 className="text-4xl md:text-5xl font-display font-bold mb-6">ПОЛУЧИ <span className="text-yellow-500 text-glow">ЗОЛОТОЙ</span> СТАТУС</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto mb-16">
              Поддержите разработку IRIS и получите эксклюзивные возможности, которые выделят ваш профиль.
            </p>
            ...
            <div className="max-w-md mx-auto bg-white/5 border border-yellow-500/30 rounded-2xl p-8 relative overflow-hidden group hover:border-yellow-500/50 transition-colors">
              ...
              <div className="text-left space-y-6 relative z-10">
                <div>
                  <p className="text-sm text-muted-foreground uppercase tracking-widest">Ежемесячная подписка</p>
                ...
                <ul className="space-y-4">
                  {[
                    "Двойные Ежедневные Награды (2x)",
                    "Эксклюзивный Золотой Значок Профиля",
                    "Уникальные Превращения в Животных",
                    "Приоритетный Доступ к Поддержке",
                    "Нет Кулдауна на Мини-игры",
        ...
        <footer className="py-12 border-t border-white/10 bg-black">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="text-muted-foreground text-sm mb-8">
              Развлекательный бот нового поколения для сообществ Telegram.
            </p>
            <div className="text-xs text-white/20 font-mono">
              © 2025 IRIS Project. Все права защищены.
            </div>
          </div>
        </footer>
      </main>
