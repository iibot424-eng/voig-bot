...
### ✅ Список команд обновлён в Telegram:
- Загружено 82 официальные команды с описаниями
- Команды видны в поле ввода мобильного клиента
- Включены все основные + 60+ RP команд
- Плюс ещё 51 RP команда работает текстом в боте
...
- 111+ RP действий (текстом в ответе И через "/" команды)
- /transform - трансформирует другого в рандомное животное
- /невидимость - 2 часа невидимости (КД 4ч)
- /daily, /weekly, /fish, /slots, /казино, /duel
